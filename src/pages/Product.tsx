      ...
      <div className="container mx-auto px-4">
        ...
        <div className="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
          ...
          <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            <h1 className="sm: text-2xl font-bold text-white sm:text-3xl">
              {title}
            </h1>
            ...
            <h2 className="mt-8 text-base text-white">{brand}</h2>
            <h2 className="mt-8 text-base text-white">{category}</h2>

            <div className="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
              <div className="flex items-end">
                <h1 className="text-3xl font-bold">${price}</h1>
                <h2 className="text-lg ml-5 font-bold line-through ">
            ...
            <div className="border-b border-gray-300">
              <nav className="flex gap-4">
                <a
                  href="#"
                  title=""
                  className="border-b-2 border-gray-900 py-4 text-sm font-medium text-white hover:border-gray-400 hover:text-gray-100"
                >
                  {" "}
                  Description{" "}
                </a>
